...
#define GIMBAL_PITCH_MIN_ANGLE            7.0f
#define GIMBAL_PITCH_MAX_ANGLE            36.5f
#define GIMBAL_PITCH_HARD_MIN_ANGLE       6.5f
#define GIMBAL_PITCH_HARD_MAX_ANGLE       37.0f
#define GIMBAL_PITCH_RC_MAX_SPEED_DPS     15.0f

#define GIMBAL_PITCH_POSITION_PID_KP      -80.0f
